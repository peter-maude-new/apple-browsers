...
struct OTPPromptView: View {
    ...
    @ObservedObject var viewModel: OTPPromptViewModel
    ...
    private func makeBodyView(_ geometry: GeometryProxy) -> some View {
        ...
        return ZStack {
            ...
            VStack {
                ...
                AutofillViews.Headline(title: "Use Your One-Time Code")
                ...
                AutofillViews.SecureDescription(text: "Your authentication codes are securely stored in DuckDuckGo.")
                contentViewSpacer
                ctaView
    ...
    private var passwordView: some View {
        VStack(spacing: 8) {
            HStack(spacing: Const.Size.passwordButtonSpacing) {
                ...
                Button {
                    UIPasteboard.general.string = viewModel.generatedOTP
                    presentCopyConfirmation(message: "Code copied")
                } label: {
                    Image.copy
    ...
    private var ctaView: some View {
        VStack(spacing: Const.Size.ctaVerticalSpacing) {
            AutofillViews.PrimaryButton(title: "Use This Code",
                                        action: viewModel.useOTPPressed)

            AutofillViews.TertiaryButton(title: "Cancel",
