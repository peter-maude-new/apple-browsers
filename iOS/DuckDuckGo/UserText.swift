...
public struct UserText {
    ...
    static let vpnErrorUnknown = NSLocalizedString("network.protection.error.unknown", value: "An unexpected error occurred. Please try again.\nIf this issue continues, scroll to About and tap FAQs and Support for help.", comment: "Generic fallback error message for VPN failures")
