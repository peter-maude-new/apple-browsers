...
public struct UserText {
    ...
    public static let newAddressBarPickerHeadline = NSLocalizedString("new.address.bar.picker.subheadline", value: "Want easier access to private AI chat?", comment: "Headline for the new address bar picker modal")
