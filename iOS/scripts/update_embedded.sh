...
performUpdate 'https://staticcdn.duckduckgo.com/trackerblocking/config/v6/ios-config.json' "${base_dir}/Core/AppPrivacyConfigurationDataProvider.swift" "${base_dir}/Core/ios-config.json"
