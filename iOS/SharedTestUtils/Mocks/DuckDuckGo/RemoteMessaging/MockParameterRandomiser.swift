...
final class MockParameterRandomiser {
    ...
    func mergeRandomizedParameters(for useCase: SubscriptionDataReportingUseCase, with parameters: [String: String]) -> [String: String] {
        ...
        capturedUseCase = useCase
        capturedParameters = parameters
        return parametersToReturn.isEmpty ? parameters : parametersToReturn
    }
}
