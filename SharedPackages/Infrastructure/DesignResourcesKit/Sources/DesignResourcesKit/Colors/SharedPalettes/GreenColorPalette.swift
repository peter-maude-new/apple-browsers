...
struct GreenColorPalette: SharedColorPaletteDefinition {
    static let accentAltContentPrimary = DynamicColor(lightHex: 0x193926, darkHex: 0xe6f2ea)
    static let accentAltContentSecondary = DynamicColor(lightHex: 0x193926, lightOpacityHex: 0xb2, darkHex: 0xe6f2ea, darkOpacityHex: 0xb2)
    static let accentAltContentTertiary = DynamicColor(lightHex: 0x193926, lightOpacityHex: 0x7f, darkHex: 0xe6f2ea, darkOpacityHex: 0x7f)
    static let accentAltGlowPrimary = DynamicColor(lightHex: 0x85e0ba, lightOpacityHex: 0x33, darkHex: 0x6ec7a2, darkOpacityHex: 0x33)
    static let accentAltGlowSecondary = DynamicColor(lightHex: 0x85e0ba, lightOpacityHex: 0x1e, darkHex: 0x6ec7a2, darkOpacityHex: 0x1e)
    static let accentAltPrimary = DynamicColor(lightHex: 0x99eac8, darkHex: 0x2c6645)
    static let accentAltSecondary = DynamicColor(lightHex: 0x85e0ba, darkHex: 0x235136)
    static let accentAltTertiary = DynamicColor(lightHex: 0x6ec7a2, darkHex: 0x193926)
    static let accentAltTextPrimary = DynamicColor(lightHex: 0x2c6645, darkHex: 0x85e0ba)
    static let accentAltTextSecondary = DynamicColor(lightHex: 0x235136, darkHex: 0x6ec7a2)
    static let accentAltTextTertiary = DynamicColor(lightHex: 0x193926, darkHex: 0x48b186)
    ...
    static let containerBorderPrimary = DynamicColor(lightHex: 0x062504, lightOpacityHex: 0x16, darkHex: 0xd9f2e5, darkOpacityHex: 0x16)
    static let containerBorderSecondary = DynamicColor(lightHex: 0x062504, lightOpacityHex: 0x1e, darkHex: 0xd9f2e5, darkOpacityHex: 0x1e)
    static let containerBorderTertiary = DynamicColor(lightHex: 0x062504, lightOpacityHex: 0x28, darkHex: 0xd9f2e5, darkOpacityHex: 0x28)
    static let containerFillPrimary = DynamicColor(lightHex: 0x062504, lightOpacityHex: 0x05, darkHex: 0xd9f2e5, darkOpacityHex: 0x05)
    static let containerFillSecondary = DynamicColor(lightHex: 0x062504, lightOpacityHex: 0x0a, darkHex: 0xd9f2e5, darkOpacityHex: 0x0a)
    static let containerFillTertiary = DynamicColor(lightHex: 0x062504, lightOpacityHex: 0x0f, darkHex: 0xd9f2e5, darkOpacityHex: 0x0f)
    ...
    static let controlsRaisedFillPrimary = DynamicColor(lightHex: 0xf8fcf7, darkHex: 0xe6f2ea, darkOpacityHex: 0x2d)
    ...
    static let surfaceDecorationPrimary = DynamicColor(lightHex: 0x1f9350, lightOpacityHex: 0x1e, darkHex: 0x88ddba, darkOpacityHex: 0x28)
    static let surfaceDecorationSecondary = DynamicColor(lightHex: 0x1f9350, lightOpacityHex: 0x33, darkHex: 0x88ddba, darkOpacityHex: 0x3d)
    static let surfaceDecorationTertiary = DynamicColor(lightHex: 0x1f9350, lightOpacityHex: 0x51, darkHex: 0x88ddba, darkOpacityHex: 0x51)
    static let surfacePrimary = DynamicColor(lightHex: 0xe3eee1, darkHex: 0x203b30)
    static let surfaceSecondary = DynamicColor(lightHex: 0xecf4eb, darkHex: 0x244133)
    static let surfaceTertiary = DynamicColor(lightHex: 0xf8fcf7, darkHex: 0x2d4d3e)
    static let textPrimary = DynamicColor(lightHex: 0x041c03, lightOpacityHex: 0xf4, darkHex: 0xf2f8f4, darkOpacityHex: 0xf4)
    static let textSecondary = DynamicColor(lightHex: 0x041c03, lightOpacityHex: 0x99, darkHex: 0xf2f8f4, darkOpacityHex: 0xa8)
    static let textTertiary = DynamicColor(lightHex: 0x041c03, lightOpacityHex: 0x5b, darkHex: 0xf2f8f4, darkOpacityHex: 0x5b)
    static let toneShadePrimary = DynamicColor(lightHex: 0x062504, lightOpacityHex: 0x0f, darkHex: 0x091510, darkOpacityHex: 0x28)
    static let toneTintPrimary = DynamicColor(lightHex: 0xf7fcfa, lightOpacityHex: 0x66, darkHex: 0xe6f8f1, darkOpacityHex: 0x0f)
