...
struct RoseColorPalette: SharedColorPaletteDefinition {
    ...
    static let containerBorderPrimary = DynamicColor(lightHex: 0x11030b, lightOpacityHex: 0x0f, darkHex: 0xfffafe, darkOpacityHex: 0x16)
    static let containerBorderSecondary = DynamicColor(lightHex: 0x11030b, lightOpacityHex: 0x16, darkHex: 0xfffafe, darkOpacityHex: 0x1e)
    static let containerBorderTertiary = DynamicColor(lightHex: 0x11030b, lightOpacityHex: 0x1e, darkHex: 0xfffafe, darkOpacityHex: 0x28)
    static let containerFillPrimary = DynamicColor(lightHex: 0x11030b, lightOpacityHex: 0x02, darkHex: 0xfffafe, darkOpacityHex: 0x07)
    ...
    static let containerFillTertiary = DynamicColor(lightHex: 0x11030b, lightOpacityHex: 0x0f, darkHex: 0xfffafe, darkOpacityHex: 0x16)
    ...
    static let surfaceDecorationPrimary = DynamicColor(lightHex: 0xa30075, lightOpacityHex: 0x28, darkHex: 0xfa7ddd, darkOpacityHex: 0x33)
    static let surfaceDecorationSecondary = DynamicColor(lightHex: 0xa30075, lightOpacityHex: 0x51, darkHex: 0xfa7ddd, darkOpacityHex: 0x51)
    static let surfaceDecorationTertiary = DynamicColor(lightHex: 0xa30075, lightOpacityHex: 0x8e, darkHex: 0xfa7ddd, darkOpacityHex: 0x8e)
    static let surfacePrimary = DynamicColor(lightHex: 0xf8ebf5, darkHex: 0x5b194b)
    static let surfaceSecondary = DynamicColor(lightHex: 0xfbf2fa, darkHex: 0x692055)
    static let surfaceTertiary = DynamicColor(lightHex: 0xfff4fc, darkHex: 0x72265e)
