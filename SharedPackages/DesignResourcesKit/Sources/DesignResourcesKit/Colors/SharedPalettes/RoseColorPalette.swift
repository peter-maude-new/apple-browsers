...
struct RoseColorPalette: SharedColorPaletteDefinition {
    ...
    // Container Colors
    static let containerDecorationPrimary = DynamicColor(lightHex: 0x11030b, lightOpacityHex: 0x16, darkHex: 0xfffafe, darkOpacityHex: 0x1e)
    static let containerDecorationSecondary = DynamicColor(lightHex: 0x11030b, lightOpacityHex: 0x0f, darkHex: 0xfffafe, darkOpacityHex: 0x16)
    static let containerDecorationTertiary = DynamicColor(lightHex: 0x11030b, lightOpacityHex: 0x0f, darkHex: 0xfffafe, darkOpacityHex: 0x16)
    static let containerFillPrimary = DynamicColor(lightHex: 0x11030b, lightOpacityHex: 0x0f, darkHex: 0xfffafe, darkOpacityHex: 0x16)
    static let containerFillSecondary = DynamicColor(lightHex: 0x11030b, lightOpacityHex: 0x07, darkHex: 0xfffafe, darkOpacityHex: 0x0f)
    static let containerFillTertiary = DynamicColor(lightHex: 0x11030b, lightOpacityHex: 0x02, darkHex: 0xfffafe, darkOpacityHex: 0x07)

    // Controls Colors
    static let controlsBase = DynamicColor(lightHex: 0xa30074, darkHex: 0xfc9be5)
    static let controlsDecorationPrimary = DynamicColor(lightHex: 0xa30075, lightOpacityHex: 0x51, darkHex: 0xfc9ce6, darkOpacityHex: 0x7a)
    static let controlsDecorationSecondary = DynamicColor(lightHex: 0xa30075, lightOpacityHex: 0x8e, darkHex: 0xfc9ce6, darkOpacityHex: 0xa3)
    static let controlsDecorationTertiary = DynamicColor(lightHex: 0xa30075, lightOpacityHex: 0xa3, darkHex: 0xfc9ce6, darkOpacityHex: 0xb7)
    static let controlsDecorationQuaternary = DynamicColor(lightHex: 0xa30075, lightOpacityHex: 0xb7, darkHex: 0xfc9ce6, darkOpacityHex: 0xcc)
    ...
    // Decoration Colors
    static let decorationPrimary = DynamicColor(lightHex: 0xa30075, lightOpacityHex: 0x33, darkHex: 0xfa7ddd, darkOpacityHex: 0x33)
    static let decorationSecondary = DynamicColor(lightHex: 0xa30075, lightOpacityHex: 0x66, darkHex: 0xfa7ddd, darkOpacityHex: 0x3d)
    static let decorationTertiary = DynamicColor(lightHex: 0xa30075, lightOpacityHex: 0x8e, darkHex: 0xfa7ddd, darkOpacityHex: 0x51)
    ...
    static let surfaceCanvas = DynamicColor(lightHex: 0xfffafe, darkHex: 0x59214a)
    static let surfacePrimary = DynamicColor(lightHex: 0xf9eff7, darkHex: 0x5b194b)
    static let surfaceSecondary = DynamicColor(lightHex: 0xfbf2fa, darkHex: 0x71275d)
    static let surfaceTertiary = DynamicColor(lightHex: 0xfff4fc, darkHex: 0x7e2e69)

    // Text Colors
    static let textPrimary = DynamicColor(lightHex: 0x30021e, lightOpacityHex: 0xf4, darkHex: 0xfffafe, darkOpacityHex: 0xf4)
    static let textSecondary = DynamicColor(lightHex: 0x30031e, lightOpacityHex: 0xa8, darkHex: 0xfffafe, darkOpacityHex: 0xa8)
