...
struct FigmaColorPalette: SharedColorPaletteDefinition {
    ...
    static let controlsFillPrimary = DynamicColor(lightHex: 0x1f1f1f, lightOpacityHex: 0x16, darkHex: 0xf9f9f9, darkOpacityHex: 0x1e)
    static let controlsFillSecondary = DynamicColor(lightHex: 0x1f1f1f, lightOpacityHex: 0x1e, darkHex: 0xf9f9f9, darkOpacityHex: 0x2d)
    static let controlsFillTertiary = DynamicColor(lightHex: 0x1f1f1f, lightOpacityHex: 0x2d, darkHex: 0xf9f9f9, darkOpacityHex: 0x3d)

    // Decoration Colors
    static let decorationPrimary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x8e, darkHex: 0xffffff, darkOpacityHex: 0x8e)
    static let decorationSecondary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x3d, darkHex: 0xffffff, darkOpacityHex: 0x33)
    static let decorationTertiary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x16, darkHex: 0xffffff, darkOpacityHex: 0x1e)
