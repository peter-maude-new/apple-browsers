...
struct FigmaColorPalette: SharedColorPaletteDefinition {
    ...
    static let controlsFillPrimary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x16, darkHex: 0xffffff, darkOpacityHex: 0x1e)
    static let controlsFillSecondary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x1e, darkHex: 0xffffff, darkOpacityHex: 0x2d)
    static let controlsFillTertiary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x2d, darkHex: 0xffffff, darkOpacityHex: 0x3d)
