//
//  UserDefaults+showDebugVPNEventNotifications.swift
//
...
extension UserDefaults {
    ...
    var networkProtectionSettingShowDebugVPNEventNotificationsPublisher: AnyPublisher<Bool, Never> {
        publisher(for: \.networkProtectionSettingShowDebugVPNEventNotifications).eraseToAnyPublisher()
    }
