...
final class DataBrokerProtectionFeatureTests: XCTestCase {
    ...
    func testWhenParseActionCompletedFailsOnParsing_thenDelegateSendsBackTheCorrectError() async {
        ...
        let sut = DataBrokerProtectionFeature(delegate: mockCSSDelegate, executionConfig: BrokerJobExecutionConfig(), shouldContinue: nil)
    ...
    private func verifyTimeoutBehavior(
        ...
        let sut = DataBrokerProtectionFeature(delegate: mockCSSDelegate, executionConfig: executionConfig, shouldContinue: nil)
