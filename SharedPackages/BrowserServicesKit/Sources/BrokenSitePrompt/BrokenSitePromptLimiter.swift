...
public protocol BrokenSitePromptLimiterStoring {
...
public final class BrokenSitePromptLimiter {
    ...
    public init(privacyConfigManager: PrivacyConfigurationManaging, store: BrokenSitePromptLimiterStoring) {
