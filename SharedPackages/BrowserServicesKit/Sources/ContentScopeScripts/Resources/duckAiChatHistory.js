/*! © DuckDuckGo ContentScopeScripts apple-ai-history https://github.com/duckduckgo/content-scope-scripts/ */
"use strict";
(() => {
  ...
  var _DuckAiChatHistory = class _DuckAiChatHistory extends ContentFeature {
    ...
    isWithinTwoWeeks(chat) {
      ...
      const cutoffTime = Date.now() - _DuckAiChatHistory.TWO_WEEKS_MS;
