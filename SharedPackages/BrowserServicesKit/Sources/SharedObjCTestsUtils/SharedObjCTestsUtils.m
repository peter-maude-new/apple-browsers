...
+ (void)load {
    ...
    if (NSClassFromString(@"UITestCase") == nil) { // disable for UI Tests
        // Instantiate TestRunHelper for Unit/Integration Tests
        ((void (*)(id, SEL))objc_msgSend)(NSClassFromString(@"TestRunHelper"), NSSelectorFromString(@"sharedInstance"));
    }
}
