//
//  MockRemoteMessagingConfigProcessor.swift
//
...
public class MockRemoteMessagingConfigProcessor: RemoteMessagingConfigProcessing {
    ...
    public init(shouldProcessConfig: Bool = true, remoteMessagingConfigMatcher: RemoteMessagingConfigMatcher) {
        self.shouldProcessConfig = shouldProcessConfig
