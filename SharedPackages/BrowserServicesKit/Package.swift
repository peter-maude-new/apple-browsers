...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/duckduckgo/content-scope-scripts", exact: "8.24.0"),
        ...
        .package(url: "https://github.com/duckduckgo/DesignResourcesKit", branch: "brindy/add-design-icons")
    ],
    targets: [
        .target(
            name: "BrowserServicesKit",
