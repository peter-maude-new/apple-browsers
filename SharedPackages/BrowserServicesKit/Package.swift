...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/duckduckgo/duckduckgo-autofill.git", branch: "matteo/autofill-refresh-ui-icons"),
        ...
        .package(url: "https://github.com/duckduckgo/content-scope-scripts", exact: "10.6.0"),
