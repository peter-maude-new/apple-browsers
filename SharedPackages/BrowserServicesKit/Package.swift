...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/duckduckgo/content-scope-scripts", branch: "pr-releases/pr-1705"),
        ...
        .package(url: "https://github.com/duckduckgo/DesignResourcesKit", exact: "4.4.0")
    ],
    targets: [
        .target(
            name: "BrowserServicesKit",
