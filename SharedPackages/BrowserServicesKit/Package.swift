...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/duckduckgo/duckduckgo-autofill.git", branch: "matteo/autocomplete-quicktype"),
        ...
        .package(url: "https://github.com/duckduckgo/content-scope-scripts", exact: "9.9.0"),
