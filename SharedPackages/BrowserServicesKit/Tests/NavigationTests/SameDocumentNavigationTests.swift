...
class SameDocumentNavigationTests: DistributedNavigationDelegateTestsBase {
    ...
    func testGoBackWithSameDocumentNavigation() throws {
        ...
        assertHistory(ofResponderAt: 0, equalsTo: [
            ...
            // #8 go back to URL#namedlink
            .willStart(Nav(action: NavAction(req(urls.localHashed, defaultHeaders.allowingExtraKeys, cachePolicy: .returnCacheDataElseLoad), .backForw(-1), from: history[16], src: main(urls.localHashed)), .approved, isCurrent: false)),
