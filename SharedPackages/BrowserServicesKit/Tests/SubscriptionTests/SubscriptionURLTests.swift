...
final class SubscriptionURLTests: XCTestCase {
    ...
    func testPlansURLComponentsWithGoToUpgradeForProduction() throws {
        // Given
        let origin = "funnel_appsettings_ios"
        let expectedURL = URL(string: "https://duckduckgo.com/subscriptions/plans?tier=pro&origin=funnel_appsettings_ios")!
    ...
    func testPlansURLComponentsWithGoToUpgradeForStaging() throws {
        // Given
        let origin = "funnel_appsettings_ios"
        let expectedURL = URL(string: "https://duckduckgo.com/subscriptions/plans?tier=pro&environment=staging&origin=funnel_appsettings_ios")!
