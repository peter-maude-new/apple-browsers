...
final class AppConfigurationURLProviderTests: XCTestCase {
    ...
    func testExternalURLDependenciesAreExpected() throws {
        ...
        XCTAssertEqual(AppConfigurationURLProvider().url(for: .privacyConfiguration).absoluteString, "https://staticcdn.duckduckgo.com/trackerblocking/config/v6/macos-config.json")
