//
//  PreferencesSubscriptionSettingsModelV1Tests.swift
//
...
final class PreferencesSubscriptionSettingsModelV1Tests: XCTestCase {

    var sut: PreferencesSubscriptionSettingsModelV1!
    var mockSubscriptionManager: SubscriptionManagerMock!
    var mockAccountManager: AccountManagerMock!
    ...
    override func setUp() {
        ...
        (mockSubscriptionManager.subscriptionEndpointService as! SubscriptionEndpointServiceMock).getSubscriptionResult = .success(subscription)
        ...
        sut = PreferencesSubscriptionSettingsModelV1(
    ...
    func testExpiredSubscriptionPurchaseButtonTitle_WhenBlackFridayWithCustomDiscount_ReturnsCorrectCTA() {
        ...
        mockWinBackOfferManager.isOfferAvailable = false
        mockBlackFridayCampaignProvider.isCampaignEnabled = true
        mockBlackFridayCampaignProvider.discountPercent = 60

        // When
        let buttonTitle = sut.expiredSubscriptionPurchaseButtonTitle

        // Then
        XCTAssertEqual(buttonTitle, UserText.blackFridayCampaignPreferencesCTA(discountPercent: 60))
    }
    ...
    func testExpiredSubscriptionPurchaseButtonTitle_WhenBothOffersAvailable_PrefersWinBack() {
        ...
        // Then - Win-back offer takes priority
        XCTAssertEqual(buttonTitle, UserText.winBackCampaignLoggedInPreferencesCTA)
    }
}
