//
//  LegacyDataImportViewModelTests.swift
//
...
final class LegacyDataImportViewModelTests: XCTestCase {
    ...
    var model: LegacyDataImportViewModel!
    ...
    func testWhenPreferredImportSourcesAvailable_firstPreferredSourceIsSelected() {
        model = LegacyDataImportViewModel(availableImportSources: [.safari, .csv, .bitwarden], preferredImportSources: [.firefox, .chrome, .bitwarden, .safari])
    ...
    func testWhenNoProfilesAreLoaded_selectedProfileIsNil() {
        model = LegacyDataImportViewModel(importSource: .safari, loadProfiles: { source in
    ...
    func testWhenNoDefaultProfileIsLoaded_firstProfileIsSelected() {
        model = LegacyDataImportViewModel(importSource: .chrome, loadProfiles: { .init(browser: $0, profiles: [ .test(for: $0), .test2(for: $0) ]) })
    ...
    func testWhenCancelButtonClicked_dismissIsCalled() {
        model = LegacyDataImportViewModel(importSource: .safari)
    ...
    func testWhenProfilesAreLoadedAndImporterCanImportStraightAway_buttonActionsAreCancelAndImport() {
        model = LegacyDataImportViewModel(importSource: .safari, loadProfiles: { .init(browser: $0, profiles: [.test(for: $0)]) }, dataImporterFactory: { _, _, _, _ in
            ImporterMock()
        })
    ...
    func testWhenProfilesAreLoadedAndImporterRequiresKeyChainPassword_buttonActionsAreCancelAndMoreInfo() {
        ...
        XCTAssertEqual(model.screen, Source.safari.legacyInitialScreen)
    }
    ...
    func testWhenNoProfilesAreLoaded_buttonActionsAreCancelAndProceedToFileImport() {
        model = LegacyDataImportViewModel(importSource: .firefox, loadProfiles: { .init(browser: $0, profiles: []) })
    ...
    func testWhenImporterCannotImportPasswords_nextScreenIsFileImport() {
        model = LegacyDataImportViewModel(importSource: .yandex, loadProfiles: { .init(browser: $0, profiles: [.test(for: $0)]) }, dataImporterFactory: { _, _, _, _ in
    ...
    func testWhenReadPermissionRequired_nextScreenIsReadPermission() {
        ...
        let expectation = LegacyDataImportViewModel(importSource: .safari, screen: .getReadPermission(.testCSV))
    ...
    func testWhenImporterRequiresPrimaryPassword_passwordIsRequested() async throws {
        ...
        let expectation = LegacyDataImportViewModel(importSource: .firefox, screen: .summary([.bookmarks, .passwords], previousScreen: .profileAndDataTypesPicker), summary: [.init(.bookmarks, .success(.init(successful: 1, duplicate: 1, failed: 1))), .init(.passwords, .success(.init(successful: 2, duplicate: 2, failed: 2)))])
        XCTAssertEqual(model.description, expectation.description)
    ...
    func testWhenImporterRequiresPrimaryPasswordAndPasswordIsInvalid_passwordIsRequestedAgain() async throws {
        ...
        let expected = LegacyDataImportViewModel(importSource: .firefox, screen: .summary([.bookmarks, .passwords], previousScreen: .profileAndDataTypesPicker), summary: [.init(.bookmarks, .success(.init(successful: 1, duplicate: 1, failed: 1))), .init(.passwords, .success(.init(successful: 2, duplicate: 2, failed: 2)))])
    ...
    func testWhenImporterRequiresPrimaryPasswordButRejected_initialStateRestored() async throws {
        ...
        let expected = LegacyDataImportViewModel(importSource: .firefox, screen: Source.firefox.legacyInitialScreen)
        XCTAssertEqual(model.description, expected.description)
    }
    ...
    func testWhenImporterRequiresKeychainPasswordButRejected_moreInfoScreenRestored() async throws {
        ...
        let expected = LegacyDataImportViewModel(importSource: .brave, screen: .moreInfo)
        XCTAssertEqual(model.description, expected.description)
    }
    ...
    func testWhenBrowserBookmarksImportSucceedsPasswordsImportSucceeds_summaryShown() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .summary([.bookmarks, .passwords], previousScreen: .profileAndDataTypesPicker), summary: [.init(.bookmarks, .success(.init(successful: 100, duplicate: 2, failed: 1))), .init(.passwords, .success(.init(successful: 13, duplicate: 42, failed: 3)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserBookmarksImportSucceedsPasswordsImportFails_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .passwords, summary: [.bookmarks]), summary: [.init(.bookmarks, .success(.init(successful: 10, duplicate: 0, failed: 0))), .init(.passwords, .failure(Failure(.passwords, .decryptionError)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserBookmarksImportSucceedsNoPasswords_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .passwords, summary: [.bookmarks, .passwords]), summary: [.init(.bookmarks, .success(.init(successful: 10, duplicate: 0, failed: 0))), .init(.passwords, .success(.init(successful: 0, duplicate: 0, failed: 0)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserBookmarksImportSucceedsNoPasswordsFileError_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .passwords, summary: [.bookmarks]), summary: [.init(.bookmarks, .success(.init(successful: 42, duplicate: 1, failed: 0))), .init(.passwords, .failure(Failure(.passwords, .noData)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserBookmarksOnlyImportSucceeds_bookmarksSummaryShown() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .summary([.bookmarks], previousScreen: .profileAndDataTypesPicker), summary: [.init(.bookmarks, .success(.init(successful: 42, duplicate: 1, failed: 3)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenFileImportOpenPanelIsRejected_fileImportScreenRestored() async throws {
        ...
        let expectation = LegacyDataImportViewModel(importSource: .firefox, screen: .fileImport(dataType: .bookmarks))
        XCTAssertEqual(model.description, expectation.description)
    }
    ...
    func testWhenBrowserPasswordsImportSucceedsBookmarksImportFails_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks, summary: [.passwords]), summary: [.init(.passwords, .success(.init(successful: 10, duplicate: 0, failed: 0))), .init(.bookmarks, .failure(Failure(.bookmarks, .decryptionError)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserBookmarksImportFailsNoPasswords_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks, summary: [.passwords]), summary: [.init(.passwords, .success(.init(successful: 0, duplicate: 0, failed: 0))), .init(.bookmarks, .failure(Failure(.bookmarks, .decryptionError)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserBookmarksImportFailsPasswordsImportFails_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks), summary: [.init(.bookmarks, .failure(Failure(.bookmarks, .dataCorrupted))), .init(.passwords, .failure(Failure(.passwords, .keychainError)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserBookmarksImportFailsNoPasswordsFileError_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks), summary: [.init(.bookmarks, .failure(Failure(.bookmarks, .dataCorrupted))), .init(.passwords, .failure(Failure(.passwords, .noData)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserBookmarksOnlyImportSucceeds_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks), summary: [.init(.bookmarks, .failure(Failure(.bookmarks, .dataCorrupted)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserNoBookmarksPasswordsImportSucceeds_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks, summary: [.bookmarks, .passwords]), summary: [.init(.bookmarks, .success(.init(successful: 0, duplicate: 0, failed: 0))), .init(.passwords, .success(.init(successful: 42, duplicate: 1, failed: 1)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserNoBookmarksPasswordsImportFails_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks, summary: [.bookmarks]), summary: [.init(.bookmarks, .success(.init(successful: 0, duplicate: 0, failed: 0))), .init(.passwords, .failure(Failure(.passwords, .decryptionError)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserNoBookmarksNoPasswords_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks, summary: [.bookmarks, .passwords]), summary: [.init(.bookmarks, .success(.init(successful: 0, duplicate: 0, failed: 0))), .init(.passwords, .success(.init(successful: 0, duplicate: 0, failed: 0)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserNoBookmarksNoPasswordsFileFound_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks, summary: [.bookmarks]), summary: [.init(.bookmarks, .success(.init(successful: 0, duplicate: 0, failed: 0))), .init(.passwords, .failure(Failure(.passwords, .noData)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserNoBookmarksOnly_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks, summary: [.bookmarks]), summary: [.init(.bookmarks, .success(.init(successful: 0, duplicate: 0, failed: 0)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserNoBookmarksFileFoundPasswordsImportSucceeds_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks, summary: [.passwords]), summary: [.init(.passwords, .success(.init(successful: 42, duplicate: 1, failed: 1))), .init(.bookmarks, .failure(Failure(.bookmarks, .noData)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserNoBookmarksFileFoundPasswordsImportFails_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks), summary: [.init(.bookmarks, .failure(Failure(.bookmarks, .noData))), .init(.passwords, .failure(Failure(.passwords, .decryptionError)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserNoBookmarksFileFoundNoPasswords_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks, summary: [.passwords]), summary: [.init(.passwords, .success(.init(successful: 0, duplicate: 0, failed: 0))), .init(.bookmarks, .failure(Failure(.bookmarks, .noData)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserNoBookmarksFileFoundNoPasswordsFileFound_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks), summary: [.init(.bookmarks, .failure(Failure(.bookmarks, .noData))), .init(.passwords, .failure(Failure(.passwords, .noData)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserNoBookmarksFileFoundOnly_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .bookmarks), summary: [.init(.bookmarks, .failure(Failure(.bookmarks, .noData)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserOnlySelectedPasswordsImportSucceeds_summaryShown() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .summary([.passwords], previousScreen: .profileAndDataTypesPicker), summary: [.init(.passwords, .success(.init(successful: 1, duplicate: 2, failed: 3)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserOnlySelectedPasswordsImportFails_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .passwords), summary: [.init(.passwords, .failure(Failure(.passwords, .dataCorrupted)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserOnlySelectedPasswordsResultsWithNoPasswords_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .passwords, summary: [.passwords]), summary: [.init(.passwords, .success(.init(successful: 0, duplicate: 0, failed: 0)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserOnlySelectedPasswordsImportResultsWithNoPasswordsFileFound_manualImportSuggested() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .passwords), summary: [.init(.passwords, .failure(Failure(.passwords, .noData)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenBrowserOnlySelectedPasswordsCannotBeImported_manualImportSuggested() throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .passwords), summary: [])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenFileImportSourceImportSucceeds_summaryShown() async throws {
        for source in Source.allCases where source.legacyInitialScreen.isFileImport {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .summary([dataType], previousScreen: .fileImport(dataType: dataType, summary: [])), summary: [.init(dataType, .success(.init(successful: 42, duplicate: 12, failed: 3)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenFileImportSourceImportSucceedsWithNoDataFound_summaryShown() async throws {
        for source in Source.allCases where source.legacyInitialScreen.isFileImport {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .summary([dataType], previousScreen: .fileImport(dataType: dataType, summary: [])), summary: [.init(dataType, .success(.init(successful: 0, duplicate: 0, failed: 0)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    func testWhenFileImportSourceImportFails_feedbackScreenShown() async throws {
        for source in Source.allCases where source.legacyInitialScreen.isFileImport {
            ...
            let expectation = LegacyDataImportViewModel(importSource: source, screen: .feedback, summary: [.init(dataType, .failure(Failure(dataType.importAction, .dataCorrupted)))])
            XCTAssertEqual(model.description, expectation.description)
        }
    }
    ...
    var bookmarksSummaries: [LegacyDataImportViewModel.DataTypeImportResult?] {
    ...
    private let bookmarkSummaryNoData: LegacyDataImportViewModel.DataTypeImportResult? = .init(.bookmarks, .failure(Failure(.bookmarks, .noData)))
    ...
    var passwordsSummaries: [LegacyDataImportViewModel.DataTypeImportResult?] {
    ...
    private let passwordSummaryNoData: LegacyDataImportViewModel.DataTypeImportResult? = .init(.passwords, .failure(Failure(.passwords, .noData)))
    ...
    func testWhenBrowsersBookmarksFileImportSucceedsAndNoPasswordsFileImportNeeded_summaryShown() async throws {
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker && source.supportedDataTypes.contains(.passwords) {
            ...
            where bookmarksSummary?.result.isSuccess == false || (try? bookmarksSummary?.result.get())?.isEmpty == true {
                ...
                where (try? passwordsSummary?.result.get().isEmpty) == false {
                    ...
                    where result?.isSuccess == true || (result == nil && (try? bookmarksSummary?.result.get())?.isEmpty == true) {
                        ...
                        // run File Import
                        let expectation: LegacyDataImportViewModel
                        if let result {
                            try await initiateImport(of: [.bookmarks], fromFile: .testHTML, resultingWith: [.bookmarks: result], xctDescr)
                            // expect Final Summary
                            expectation = LegacyDataImportViewModel(importSource: source, screen: .summary([.bookmarks], previousScreen: .fileImport(dataType: .bookmarks, summary: [.bookmarks])), summary: [bookmarksSummary, passwordsSummary, .init(.bookmarks, result)].compactMap { $0 })
        ...
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            where bookmarksSummary?.result.isSuccess == false || (try? bookmarksSummary?.result.get())?.isEmpty == true {
                ...
                where result?.isSuccess == true {
                    ...
                    // expect Final Summary
                    let expectation = LegacyDataImportViewModel(importSource: source, screen: .summary([.bookmarks], previousScreen: .fileImport(dataType: .bookmarks, summary: [.bookmarks])), summary: [bookmarksSummary, result.map { .init(.bookmarks, $0) }].compactMap { $0 })
                    XCTAssertEqual(model.description, expectation.description, xctDescr)
                    XCTAssertEqual(model.actionButton, .next(.shortcuts([.bookmarks])), xctDescr)
                    XCTAssertNil(model.secondaryButton, xctDescr)
                }
    ...
    func testWhenSummaryShown_shouldShowSyncFooterButton() async throws {
        let model = LegacyDataImportViewModel(importSource: .chrome, screen: .summary([.bookmarks], previousScreen: .profileAndDataTypesPicker), summary: [])
        XCTAssertTrue(model.shouldShowSyncFooterButton)
    }

    @MainActor
    func testWhenShortcutsShown_shouldShowSyncFooterButton() async throws {
        let model = LegacyDataImportViewModel(importSource: .chrome, screen: .shortcuts([.bookmarks]), summary: [])
        XCTAssertTrue(model.shouldShowSyncFooterButton)
    }

    @MainActor
    func testWhenAllOtherScreensShow_shouldNotShowSyncFooterButton() async throws {
        for screen: LegacyDataImportViewModel.Screen in [.profileAndDataTypesPicker, .moreInfo, .getReadPermission(.aboutDuckDuckGo), .fileImport(dataType: .bookmarks), .feedback] {
            let model = LegacyDataImportViewModel(importSource: .chrome, screen: screen, summary: [])
            ...
            || (try? bookmarksSummary?.result.get())?.isEmpty == true {
                ...
                where (try? passwordsSummary?.result.get().isEmpty) == false {
                    ...
                    where result?.isSuccess == false || (result == nil && bookmarksSummary?.result.isSuccess == false) {
                        ...
                        let expectation = LegacyDataImportViewModel(importSource: source, screen: .feedback, summary: [bookmarksSummary, passwordsSummary, result.map { .init(.bookmarks, $0) }].compactMap { $0 })
                        XCTAssertEqual(model.description, expectation.description, xctDescr)
        ...
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker {
            ...
            where bookmarksSummary?.result.isSuccess == false || (try? bookmarksSummary?.result.get())?.isEmpty == true {
                ...
                where result?.isSuccess == false {
                    ...
                    // expect Report Feedback
                    let expectation = LegacyDataImportViewModel(importSource: source, screen: .feedback, summary: [bookmarksSummary, result.map { .init(.bookmarks, $0) }].compactMap { $0 })
                    XCTAssertEqual(model.description, expectation.description, xctDescr)
                    XCTAssertEqual(model.actionButton, .submit, xctDescr)
                    XCTAssertEqual(model.secondaryButton, .cancel, xctDescr)
                }
            ...
            where bookmarksSummary?.result.isSuccess == false || (try? bookmarksSummary?.result.get())?.isEmpty == true {
                ...
                where passwordsSummary?.result.isSuccess != true || (try? passwordsSummary?.result.get().isEmpty) == true {
                    ...
                    where result != nil {
                        ...
                        let expectation = LegacyDataImportViewModel(importSource: source, screen: .summary([.bookmarks], previousScreen: .fileImport(dataType: .bookmarks, summary: [.bookmarks])), summary: [bookmarksSummary, passwordsSummary, result.map { .init(.bookmarks, $0) }].compactMap { $0 })
                        XCTAssertEqual(model.description, expectation.description, xctDescr)
        ...
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker && source.supportedDataTypes.contains(.passwords) {
            ...
            where bookmarksSummary?.result.isSuccess == false || (try? bookmarksSummary?.result.get())?.isEmpty == true {
                ...
                where passwordsSummary?.result.isSuccess != true || (try? passwordsSummary?.result.get().isEmpty) == true {
                    ...
                    // expect Bookmarks Import Summary screen
                    let expectation = LegacyDataImportViewModel(importSource: source, screen: .fileImport(dataType: .passwords), summary: [bookmarksSummary, passwordsSummary].compactMap { $0 })
                    XCTAssertEqual(model.description, expectation.description, xctDescr)
                ...
                where passwordsSummary?.result.isSuccess == false || (try? passwordsSummary?.result.get().isEmpty) == false {
                    ...
                    || (bookmarksSummary?.result.isSuccess == true && bookmarksFileImportSummary == nil) {
                        ...
                        where result?.isSuccess == true || (result == nil && (try? passwordsSummary?.result.get())?.isEmpty == true) {
                            ...
                            // expect Final Summary
                            let expectation = LegacyDataImportViewModel(importSource: source, screen: .summary([.passwords], previousScreen: .fileImport(dataType: .passwords, summary: [])), summary: [bookmarksSummary, passwordsSummary, bookmarksFileImportSummary, result.map { .init(.passwords, $0) }].compactMap { $0 })
                            XCTAssertEqual(model.description, expectation.description, xctDescr)
        ...
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker && source.supportedDataTypes.contains(.passwords) {
            ...
            where passwordsSummary?.result.isSuccess == false || (try? passwordsSummary?.result.get())?.isEmpty == true {
                ...
                where result?.isSuccess == true {
                    ...
                    // expect Final Summary
                    let expectation = LegacyDataImportViewModel(importSource: source, screen: .summary([.passwords], previousScreen: .fileImport(dataType: .passwords, summary: [])), summary: [passwordsSummary, result.map { .init(.passwords, $0) }].compactMap { $0 })
                    XCTAssertEqual(model.description, expectation.description, xctDescr)
                    XCTAssertEqual(model.actionButton, .next(.shortcuts([.passwords])), xctDescr)
                    XCTAssertNil(model.secondaryButton, xctDescr)
                }
                ...
                || (try? passwordsSummary?.result.get().isEmpty) == false {
                    ...
                    || (bookmarksSummary?.result.isSuccess == true && bookmarksFileImportSummary == nil) {
                        ...
                        where result?.isSuccess == false || (result == nil && passwordsSummary?.result.isSuccess == false) {
                            ...
                            // expect Report Feedback
                            let expectation = LegacyDataImportViewModel(importSource: source, screen: .feedback, summary: [bookmarksSummary, passwordsSummary, bookmarksFileImportSummary, result.map { .init(.passwords, $0) }].compactMap { $0 })
                            XCTAssertEqual(model.description, expectation.description, xctDescr)
                            XCTAssertEqual(model.actionButton, .submit, xctDescr)
                            XCTAssertEqual(model.secondaryButton, .cancel, xctDescr)
                        }
        ...
        for source in Source.allCases where source.legacyInitialScreen == .profileAndDataTypesPicker && source.supportedDataTypes.contains(.passwords) {
            ...
            where passwordsSummary?.result.isSuccess == false || (try? passwordsSummary?.result.get())?.isEmpty == true {
                ...
                where result?.isSuccess == false {
                    ...
                    // expect Report Feedback
                    let expectation = LegacyDataImportViewModel(importSource: source, screen: .feedback, summary: [passwordsSummary, result.map { .init(.passwords, $0) }].compactMap { $0 })
                    XCTAssertEqual(model.description, expectation.description, xctDescr)
                    XCTAssertEqual(model.actionButton, .submit, xctDescr)
                    XCTAssertEqual(model.secondaryButton, .cancel, xctDescr)
                }
    ...
    func testFeedbackSending() {
        ...
        let summary: [LegacyDataImportViewModel.DataTypeImportResult] = [
        ...
        model = LegacyDataImportViewModel(importSource: .safari, screen: .feedback, summary: summary, reportSenderFactory: {
            { report in
    ...
    func setupModel(with source: Source, profiles: [(ThirdPartyBrowser) -> BrowserProfile] = [], screen: LegacyDataImportViewModel.Screen? = nil, summary: [LegacyDataImportViewModel.DataTypeImportResult] = [], dataImporterFactory: LegacyDataImportViewModel.DataImporterFactory? = nil, requestPrimaryPasswordCallback: ((LegacyDataImportViewModel.Source) -> String?)? = nil) {
        model = LegacyDataImportViewModel(importSource: source, screen: screen, summary: summary, loadProfiles: { browser in
    ...
    func initiateImport(of dataTypes: Set<DataType>, from profile: BrowserProfile? = nil, fromFile url: URL? = nil, resultingWith result: DataImportSummary? = nil, file: StaticString = #filePath, line: UInt = #line, _ descr: String? = nil, progress progressUpdateCallback: ((DataImportProgressEvent) -> Void)? = nil) async throws {
        ...
        var model: LegacyDataImportViewModel = self.model
        if let url, case .fileImport = model.screen { // file import
            ...
            if !source.isBrowser {
                XCTAssertNil(model.actionButton, file: file, line: line)
                ...
                XCTAssertEqual(model.actionButton, .cancel, file: file, line: line)
            } else if case .profileAndDataTypesPicker = model.importSource.legacyInitialScreen {
        ...
        while let importProgress = self.model.importProgress {
            ...
            let task = Task<LegacyDataImportViewModel?, Never> {
                taskStarted.fulfill()
    ...
    func testDataTypesSelectionWhenAllDataTypesSelected_returnsAll() {
        // GIVEN
        model = LegacyDataImportViewModel(importSource: .chrome)
    ...
    func testIsArchiveImportReturnsTrueForArchiveImportScreen() {
        // GIVEN
        let screen = LegacyDataImportViewModel.Screen.archiveImport(dataTypes: [.bookmarks, .passwords])
    ...
    func testIsArchiveImportReturnsFalseForNonArchiveImportScreens() {
        // GIVEN
        let screens: [LegacyDataImportViewModel.Screen] = [
    ...
    func testSafariInitialScreenReturnsArchiveImportWhenFeatureFlagEnabled() {
        // GIVEN
        let safariSources: [Source] = [.safari, .safariTechnologyPreview]

        // WHEN & THEN
        for source in safariSources {
            // Note: This test assumes the feature flag is enabled in test environment
            // The actual behavior depends on the feature flag and macOS version
            let initialScreen = source.legacyInitialScreen
            // We can't easily test the feature flag condition in unit tests,
            // but we can test that the screen is one of the expected types
            XCTAssertTrue(initialScreen == .archiveImport(dataTypes: source.supportedDataTypes) ||
                         initialScreen == .profileAndDataTypesPicker,
                         "Safari source \(source) should return archive import or profile picker")
        }
    }
    ...
    func testArchiveImportScreenDescriptionWithSingleDataType() {
        // GIVEN
        let screen = LegacyDataImportViewModel.Screen.archiveImport(dataTypes: [.bookmarks])
    ...
    func testArchiveImportScreenDescriptionWithAllDataTypes() {
        // GIVEN
        let screen = LegacyDataImportViewModel.Screen.archiveImport(dataTypes: [.bookmarks, .passwords, .creditCards])
    ...
    @MainActor
    func testArchiveImportSelectFileCancellation() {
        // GIVEN
        openPanelCallback = { _ in
            return nil
        }
        ...
        let initialScreen = model.screen

        // WHEN
        model.selectFile()

        // THEN
        XCTAssertEqual(model.screen, initialScreen, "Screen should remain unchanged when file selection is cancelled")
    }
    ...
    func testArchiveImportSuccessfulImportFlow() async throws {
        ...
        // THEN
        let expected = LegacyDataImportViewModel(importSource: .safari, screen: .summary([.bookmarks, .passwords], previousScreen: .archiveImport(dataTypes: [.bookmarks, .passwords])), summary: [
    ...
    func testArchiveImportMixedResults() async throws {
        ...
        // THEN
        let expected = LegacyDataImportViewModel(importSource: .safari, screen: .fileImport(dataType: .passwords, summary: [.bookmarks]), summary: [
            .init(.bookmarks, .success(.init(successful: 10, duplicate: 2, failed: 1))),
            .init(.passwords, .failure(Failure(.passwords, .dataCorrupted)))
        ])
        XCTAssertEqual(model.description, expected.description)
    ...
    func testArchiveImportNoDataFound() async throws {
        ...
        // THEN
        let expected = LegacyDataImportViewModel(importSource: .safari, screen: .fileImport(dataType: .bookmarks, summary: [.bookmarks, .passwords]), summary: [
            .init(.bookmarks, .success(.init(successful: 0, duplicate: 0, failed: 0))),
            .init(.passwords, .success(.init(successful: 0, duplicate: 0, failed: 0)))
        ])
        XCTAssertEqual(model.description, expected.description)
    ...
    func testArchiveImportWithImportFailure() async throws {
        ...
        // THEN
        let expected = LegacyDataImportViewModel(importSource: .safari, screen: .archiveImport(dataTypes: [.bookmarks, .passwords]), summary: [
            .init(.bookmarks, .failure(Failure(.bookmarks, .dataCorrupted))),
            .init(.passwords, .failure(Failure(.passwords, .keychainError)))
        ])
        XCTAssertEqual(model.description, expected.description)
...
extension LegacyDataImportViewModel: CustomStringConvertible {
    public var description: String {
        "LegacyDataImportViewModel(importSource: .\(importSource.rawValue), screen: \(screen)\(!summary.isEmpty ? ", summary: \(summary)" : ""))"
    }
}

extension LegacyDataImportViewModel.Screen: CustomStringConvertible {
    public var description: String {
        switch self {
...
extension LegacyDataImportViewModel.ButtonType: CustomStringConvertible {
    public var description: String {
        switch self {
...
extension LegacyDataImportViewModel.DataTypeImportResult: CustomStringConvertible {
    public var description: String {
