...
public enum UpdateControllerStorageKeys: String, StorageKeyDescribing {
    ...
    // Cached pending update info (encoded PendingUpdateInfo)
...
public struct UpdateControllerSettings: StoringKeys {
    ...
    // Cached pending update info (encoded PendingUpdateInfo)
    public let pendingUpdateInfo = StorageKey<Data>(UpdateControllerStorageKeys.pendingUpdateInfo, assertionHandler: { _ in })
