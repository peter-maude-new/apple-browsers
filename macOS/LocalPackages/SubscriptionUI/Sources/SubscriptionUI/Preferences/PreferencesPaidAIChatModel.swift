//
//  PreferencesPaidAIChatModel.swift
//
...
public final class PreferencesPaidAIChatModel: ObservableObject {
    ...
    @MainActor
    func didAppear() {
        userEventHandler(.didOpenAICPreferencePane)
    }

    @MainActor
    func openPaidAIChat() {
        userEventHandler(.openAIC)
    }
