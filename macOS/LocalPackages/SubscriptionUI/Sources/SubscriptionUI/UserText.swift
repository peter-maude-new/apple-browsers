...
enum UserText {
    ...
    static let duckAIPremiumTitle = NSLocalizedString("subscription.preferences.services.duck.ai.premium.title", bundle: Bundle.module, value: "Duck.ai Pro", comment: "Title for the duck.ai premium listed in the subscription preferences pane")
    static let duckAIPremiumServiceDescription = NSLocalizedString("subscription.preferences.services.duck.ai.premium.description", bundle: Bundle.module, value: "Upgrades Duck.ai with advanced AI models.", comment: "Description for the Duck.ai premium service listed in the subscription preferences pane")
    ...
    static let preferencesDuckAIProTitle = NSLocalizedString("subscription.duck.ai.premium.title", bundle: Bundle.module, value: "Duck.ai Pro", comment: "Title of the preferences pane for Duck.ai Pro")
    static let openDuckAIProButton = NSLocalizedString("subscription.preferences.open.duck.ai.pro.button", bundle: Bundle.module, value: "Open Duck.ai Pro", comment: "Title for the preferences pane button to open Duck.ai Pro")
    ...
    static func preferencesSubscriptionInactiveCaption(region: SubscriptionRegion, isDuckAIPremiumEnabled: Bool) -> String {
        switch region {
        case .usa:
            if isDuckAIPremiumEnabled {
