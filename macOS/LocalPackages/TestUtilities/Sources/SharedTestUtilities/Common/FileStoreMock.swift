...
public final class FileStoreMock: NSObject {

    private var _fileStorage = [String: Data]()
    private let fileStorageLock = NSLock()
    @objc public dynamic var storage: [String: Data] {
        get {
    ...
    @objc public dynamic var directoryStorage: [String: [String]] {
        get {
    ...
    public var failWithError: Error?
    public var delay: TimeInterval = 0

    public func persist(_ data: Data, url: URL) -> Bool {
        if delay > 0 {
    ...
    public var decryptImpl: (Data) -> Data? = { $0 }
    public func decrypt(_ data: Data) -> Data? {
        decryptImpl(data)
    }

    public func loadData(at url: URL, decryptIfNeeded: Bool) -> Data? {
    ...
    public func hasData(at url: URL) -> Bool {
