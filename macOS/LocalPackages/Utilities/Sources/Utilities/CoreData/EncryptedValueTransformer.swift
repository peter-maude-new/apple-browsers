...
public final class EncryptedValueTransformer<T: NSSecureCoding & NSObject>: ValueTransformer {
    ...
    public static func registerTransformer(keyStore: EncryptionKeyStoring) throws {
