...
// TODO: Done till here
    ...
    static let duckAIPremium = NSLocalizedString("preferences.duckAIPremium", value: "Duck.ai Pro", comment: "Title of the option to show the Duck.ai Pro preferences")
