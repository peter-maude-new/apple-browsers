...
// TODO: Done till here
    ...
    // Recent Activity
    static let newTabProtectionsSectionTitle = NSLocalizedString("newTab.protections.section.title", value: "Privacy Protections", comment: "Title of the Protections section in the home page")
