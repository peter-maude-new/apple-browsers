...
final class TranslationPopover: NSPopover {
    ...
    required init?(coder: NSCoder) {
        fatalError("TranslationPopover: Bad initializer")
    }
    ...
    private func setupViewController() {
        let viewModel = TranslationPopoverViewModel()
        contentViewController = NSHostingController(rootView: TranslationPopoverView(model: viewModel))
