...
protocol AIChatExpandedContainerViewControllerDelegate: AnyObject {
    func aiChatExpandedContainerViewController(_ controller: AIChatExpandedContainerViewController, didSubmitText text: String)
}
...
final class AIChatExpandedContainerViewController: NSViewController {
    ...
    weak var delegate: AIChatExpandedContainerViewControllerDelegate?
    ...
    @objc private func submitButtonClicked() {
        ...
        delegate?.aiChatExpandedContainerViewController(self, didSubmitText: text)
