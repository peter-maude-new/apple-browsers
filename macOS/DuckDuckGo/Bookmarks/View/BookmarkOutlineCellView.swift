...
final class BookmarkOutlineCellView: NSTableCellView {
    ...
    static func preferredContentWidth(for object: Any?, theme: ThemeDefinition) -> CGFloat {
        ...
        let sizingCell = sizingCell(theme: theme)
...
extension BookmarkOutlineCellView {
    final class PreviewView: NSView {
        ...
        init() {
            ...
            let theme = VisualStyle.buildVisualStyle(themeName: .default)
            let cells = [
                BookmarkOutlineCellView(identifier: .init(""), theme: theme),
                BookmarkOutlineCellView(identifier: .init(""), theme: theme),
                BookmarkOutlineCellView(identifier: .init(""), theme: theme),
                BookmarkOutlineCellView(identifier: BookmarkOutlineCellView.identifier(for: .bookmarksMenu), theme: theme),
                BookmarkOutlineCellView(identifier: .init(""), theme: theme),
                BookmarkOutlineCellView(identifier: .init(""), theme: theme),
                BookmarkOutlineCellView(identifier: .init(""), theme: theme),
                BookmarkOutlineCellView(identifier: BookmarkOutlineCellView.identifier(for: .bookmarksMenu), theme: theme),
